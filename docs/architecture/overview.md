...
Terraform owns the project/bootstrap boundary, shared VPC, per-region subnets and NAT, security and logging resources, two regional Autopilot clusters, Fleet registration, and MCI/MCS feature enablement. Kustomize owns Kubernetes namespaces, narrow pipeline RBAC, regional workloads, and the MCI/MCS resources.
